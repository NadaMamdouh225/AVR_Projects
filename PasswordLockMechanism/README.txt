This is a password lock mechanism project using ESP microcontroller and the code was written using arduino ide, with mobile app to use a bluetooth keypad instead of the hardware keypad
